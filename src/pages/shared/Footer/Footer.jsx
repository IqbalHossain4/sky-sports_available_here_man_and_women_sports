...
const Footer = () => {
  return (
    <div className="bg-gradient-to-r from-[#E1AEFF]  to-[#FF78C4]  font-serif text-white">
      <footer className="footer p-10  ">
        <div>
          <span className="uppercase text-md text-black font-bold">
            Services
          </span>
        ...
        <div>
          <span className="uppercase text-md text-black font-bold">Social</span>
